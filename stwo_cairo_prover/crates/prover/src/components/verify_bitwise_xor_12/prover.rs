#![allow(unused_parens)]
use super::component::{Claim, InteractionClaim, BITWISE_XOR_12LOG_SIZE, BITWISE_XOR_12_N_BITS};
use crate::cairo_air::preprocessed::BitwiseXor;
use crate::components::prelude::proving::*;

pub type InputType = [M31; 3];
const N_TRACE_COLUMNS: usize = 1;
const PACKED_LOG_SIZE: u32 = BITWISE_XOR_12LOG_SIZE - LOG_N_LANES;
...
impl ClaimGenerator {
    ...
    pub fn new() -> Self {
        Self {
            mults: AtomicMultiplicityColumn::new(1 << BITWISE_XOR_12LOG_SIZE),
        }
    }
...
fn write_trace_simd(mults: Vec<PackedM31>) -> (ComponentTrace<N_TRACE_COLUMNS>, LookupData) {
    ...
    let (mut trace, mut lookup_data) = unsafe {
        (
            ComponentTrace::<N_TRACE_COLUMNS>::uninitialized(BITWISE_XOR_12LOG_SIZE),
...
impl InteractionClaimGenerator {
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        let mut logup_gen = LogupTraceGenerator::new(BITWISE_XOR_12LOG_SIZE);
